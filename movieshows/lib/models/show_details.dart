...
//
//     final showDetailsModel = showDetailsModelFromJson(jsonString);

import 'dart:convert';

ShowDetailsModel showDetailsModelFromJson(String str) =>
    ShowDetailsModel.fromJson(json.decode(str));

String showDetailsModelToJson(ShowDetailsModel data) =>
